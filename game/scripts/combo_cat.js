(function (cjs, an) {
	...
	p.nominalBounds = new cjs.Rectangle(-200,-358,400,358);
	...
	(lib.catStandInit = function(mode,startPosition,loop) {
		this.initialize(mode,startPosition,loop,{});
	
		// Layer_1
		this.instance = new lib.s0097_15_3();
		this.instance.setTransform(-297,-400);
	
		this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.catStandInit, new cjs.Rectangle(-297,-400,594,800), null);
	...
	(lib.catstand_saferect = function(mode,startPosition,loop) {
		this.initialize(mode,startPosition,loop,{});
	
		// Layer_1
		this.instance = new lib.CachedBmp_4();
		this.instance.setTransform(-85.65,-68.2,0.5,0.5);
	
		this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.catstand_saferect, new cjs.Rectangle(-85.6,-68.2,171.5,136.5), null);
	...
	(lib.catstand = function(mode,startPosition,loop) {
		...
		// Layer_3
		this.safeRect = new lib.catstand_saferect();
		this.safeRect.name = "safeRect";
		this.safeRect.setTransform(8.35,4.55);
		this.safeRect.alpha = 0;
	
		this.instance = new lib.CachedBmp_3();
		this.instance.setTransform(-77.8,-64.15,0.5,0.5);
	
		this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.safeRect}]}).wait(1));
	
		// Layer_1
		this.instance_1 = new lib.s0097_15_3();
		this.instance_1.setTransform(-297,-800);
	
		this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.catstand, new cjs.Rectangle(-297,-800,594,873.4), null);
	...
	(lib.cat_main_1 = function(mode,startPosition,loop) {
		this.initialize(mode,startPosition,loop,{cat_stand_frame:0,cat_jump_frame:1,cat_jump_over_frame:38,cat_shock_frame:39});
		...
		this.catJump = new lib.Tween11();
		this.catJump.name = "catJump";
		this.catJump.setTransform(-0.3,-1.3,1.1132,1.1131,0,0,0,0,-0.8);
		this.catJump._off = true;
	
		this.catJump_1 = new lib.Tween12();
		this.catJump_1.name = "catJump_1";
		this.catJump_1.setTransform(-0.3,-938.7,1.1132,1.1131,0,0,0,0,-0.6);
		this.catJump_1._off = true;
	
		this.catJump_2 = new lib.Tween13();
		this.catJump_2.name = "catJump_2";
		this.catJump_2.setTransform(0.1,-486.25,1.1132,1.1131,0,0,0,0.1,-0.4);
	...
	p.nominalBounds = new cjs.Rectangle(-426,-1260.8,852,1739.8);
	...
	(lib.moving_can = function(mode,startPosition,loop) {
		...
		// Layer_2
		this.man = new lib.man_1();
		this.man.name = "man";
		this.man.setTransform(50.45,-2.4,1,1.0296,0,-13.7792,0);
	
		this.timeline.addTween(cjs.Tween.get(this.man).to({scaleY:1,skewX:-0.3855},3,cjs.Ease.get(1)).to({scaleY:1.0211,skewX:11.675},4,cjs.Ease.get(0.5)).to({scaleY:1.0296,skewX:-13.7792},4,cjs.Ease.get(1)).wait(1));
	...
	p.nominalBounds = new cjs.Rectangle(-180.2,-86,309.1,167.1);
	...
	(lib.combo_cat = function(mode,startPosition,loop) {
		...
		// cat_shock
		this.catShock = new lib.cat_shock();
		this.catShock.name = "catShock";
		this.catShock.setTransform(508.7,601.55,0.1367,0.1367,0,0,0,203.8,-78.7);
	
		this.timeline.addTween(cjs.Tween.get(this.catShock).wait(35));
	
		// cat_1
		this.cat = new lib.cat_main_1();
		this.cat.name = "cat";
		this.cat.setTransform(187.3,467.4,0.1649,0.1649);
		...
		this.movingCan.setTransform(219.75,493.6,0.7872,0.7872,0,0,0,-25.7,-2.4);
	...
	p.nominalBounds = new cjs.Rectangle(186.5,333.5,380.4,342);
	// library properties:
	lib.properties = {
